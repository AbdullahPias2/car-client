            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] rounded-xl">
                    <div className='text-white space-y-7  pl-12 w-1/2'>
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dolorum earum itaque sit soluta totam, sapiente amet delectus consequuntur aperiam?</p>
